...
*	Running Movement barriers analyses, including [Circuitscape](https://circuitscape.org/) modelling 
...
To run the the Movement barriers analyses (Circuitscape) run the following code embedded in a shell script:
...
singularity exec ./bioconductor_3.14.sif Rscript ./-scripts-/run_LOE_movement_barriers.R 'Afrixalus_fornasini'  ```
